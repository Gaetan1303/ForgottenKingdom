...
echo
for prologue_test in test_creation_classes_ui.gd test_expedition_corruption.gd test_campaign_states.gd test_playable_prologue.gd test_power_objectives.gd test_memory_sequences.gd test_multiroute_campaign.gd test_memorial_resume.gd test_prologue_navigation.gd; do
